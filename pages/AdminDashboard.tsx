...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ 
  ...
  const [newNotice, setNewNotice] = useState({ title: '', content: '', category: 'General', pdfUrl: '', fileName: '' });
  ...
  const [newDownload, setNewDownload] = useState({ title: '', category: 'Form', fileUrl: '', fileName: '' });
  ...
  const handleAddNotice = () => {
    ...
    setIsAdding(false);
    setNewNotice({ title: '', content: '', category: 'General', pdfUrl: '', fileName: '' });
  };
  ...
  const handleAddDownload = () => {
    ...
    setIsAdding(false);
    setNewDownload({ title: '', category: 'Form', fileUrl: '', fileName: '' });
  };
  ...
  const renderAddForm = () => {
    ...
    return (
      <div className="bg-white p-4 md:p-6 rounded-2xl shadow-lg border border-blue-100 mb-8 animate-in fade-in slide-in-from-top-4">
